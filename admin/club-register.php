 ...
 ?>
        ...
        <table class="tbl-full">
            ...
            //Query to get all registers from database
               ...
               $sql = "SELECT*FROM tbl_order WHERE  club= '$club_title'";
               //Execute the query
               ...
               $res = mysqli_query($conn,$sql);
                ...
                ?>
                <b style="color:blue"><?php echo $club_title; ?></b><br/>
               ...
               //Register available
                ...
                <a href="<?php echo SITEURL;?>admin/update-register.php? id=<?php echo $id; ?>" class="btn-secondary"> Update Register</a>
                   ...
                   ?>
                   <tr>
                    <td colspan="6"><div class="error">No Registration on this club event.</div></td>
                   </tr>
                   <?php
