...
<div class="main-content">
        ...
        <br/>
        <!-- Button to add admin -->
         <a href="add-club.php"  class="btn-primary">Add Club</a>
         <br/><br/>
            ...
            //Query to get all clubs from database
               ...
               $res = mysqli_query($conn,$sql);
                ...
                if($image_name!=""){
                    //Display the image
                    ?>
                    <img src="<?php echo SITEURL;?>images/club/<?php echo $image_name;?>" width="100px" >
                    <?php
                ...
                <a  href="<?php echo SITEURL;?>admin/club-register.php? id=<?php echo $id; ?>" class="btn-secondary2"> Registration</a>
